            ...
            <div class="flex flex-wrap">
              <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                <div class="flex items-start">
                  <div class="shrink-0">
                    <div class="inline-block rounded-md bg-primary p-4 lh-color">
                      <svg
                  ...
                  <div class="ml-6 grow">
                    ...
                    <p class="text-sm text-neutral-500">example1@gmail.com</p>
                    <p class="text-sm text-neutral-500">exampl2@gmail.com</p>
                  </div>
                </div>
              </div>
              <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
              ...
              <div class="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                <div class="align-start flex">
                  ...
                  <div class="ml-6 grow">
                    ...
                    <p class="text-neutral-500">+977 9876543211</p>
                    <p class="text-neutral-500">+977 1234567890</p>
                  </div>
                </div>
              </div>
            </div>
